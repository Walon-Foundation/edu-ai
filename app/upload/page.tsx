...
export default function UploadPage() {
  ...
  const allFilesCompleted = uploadedFiles.length > 0 && uploadedFiles.every(file => file.status === 'completed');
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto px-2">
            Upload up to 3 PDF files to generate summaries, flashcards, and study materials.
            Our AI will process them instantly.
          </p>
        </div>
          ...
          <Card className="w-full">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm sm:text-base">
                Drag and drop your PDF files here, or click to browse. Maximum 3 files.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div
                ...
                {uploadedFiles.length >= 3 && (
                  <Alert className="mt-3 sm:mt-4 bg-amber-50 border-amber-200">
                    ...
                    <AlertDescription className="text-amber-800 text-xs sm:text-sm">
                      Maximum file limit reached (3 files). Remove files to upload more.
                    </AlertDescription>
                  </Alert>
                )}
              </div>
              ...
              {uploadedFiles.length > 0 && (
                <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row gap-3 sm:justify-between sm:items-center">
                  <div className="text-xs sm:text-sm text-gray-500">
                    ...
                    {allFilesCompleted ? 'Ready to process' : 'Processing files...'}
                  </div>
                    ...
                    {uploadedFiles.map((file) => (
                      ...
                      >
                        <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
                              ...
                              <Badge variant="secondary" className={getStatusColor(file.status) + " w-fit"}>
                        ...
                        <Button
                          ...
                          disabled={file.status === 'uploading' || isSendingToServer}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-lg sm:text-xl">What You'll Get</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Smart Summaries</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Concise overview of key concepts</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Flashcards</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Study cards for quick revision</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Q&A Generator</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Practice questions and answers</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-lg sm:text-xl">Upload Tips</CardTitle>
              </CardHeader>
